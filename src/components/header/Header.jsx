                            ...
                            <div id="site-logo" className="clearfix">
                                <div id="site-logo-inner">
                                    <Link to="/" rel="home" className="main-logo">
                                        <img id="logo_header" className='logo-dark' src={logo} srcSet={logo2x} alt="Spiderweb.ai logo" />
                                        <img id="logo_header" className='logo-light' src={logolight} srcSet={logolight2x} alt="Spiderweb.ai logo" />
                                    </Link>
                                </div>
                            </div>
                            <form className="form-search">
                                <input type="text" placeholder="Search a model" />
